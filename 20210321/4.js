...
// 数组迭代方法：forEach / map / filter / find / some / every / reduce / reduceRight ...
// let arr = [1, 2, 3, 4];
...
//==========================
/* 
// 闭包应用：利用闭包的“保存”作用，我们可以把一些信息预先存储起来「预处理」，供其下级上下文中后期拿来使用，我们把这种预先存储/预先处理的机制称之为“函数柯理化”
...
// 临时闭包：params -> [1, 2]  预先存储起来，还没有处理呢
// proxy(3)  args -> [3]  需要把之前存储起来的值params和最新传递的值args合并在一起，在进行求和
//    params=[1,2,3] 
*/
...
//     return x + y;
// }
// console.log(func); //控制台看到的是字符串，只不过前面标注一个f，代表是函数转换成为的字符串「控制台的机制」
