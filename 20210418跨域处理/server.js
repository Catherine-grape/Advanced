...
/*-MIDDLE WARE-*/
let safeList = ['http://127.0.0.1:5500', 'http://127.0.0.1:8080', 'http://127.0.0.1:3000'];
app.use((req, res, next) => {
	/*
	   “*”：允许所有的源「不安全，同时也不支持携带任何的资源凭证了」  
	...
	// 在CORS跨域资源共享中，客户端发送真正的请求之前，会先发送一个试探性请求OPTIONS：验证一下当前客户端和服务器端是否可以正常的通信...
